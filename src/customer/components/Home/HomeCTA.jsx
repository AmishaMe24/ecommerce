...
export default function HomeCTA() {
  return (
    <div className="relative isolate overflow-hidden bg-slate-50 py-16 sm:py-24 lg:py-32">
          ...
          <div className="max-w-xl lg:max-w-lg">
            ...
            <div className="mt-6 flex max-w-md gap-x-4">
              ...
              <input
                ...
                autoComplete="email"
                className="min-w-0 flex-auto rounded-md border-0 bg-white/5 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm/6"
              />
              <button
                type="submit"
      ...
      >
        <div
          ...
          className="aspect-[1155/678] w-[72.1875rem] bg-gradient-to-tr from-[#bfdbfe] to-[#3b82f6] opacity-30"
        />
      </div>
    </div>
  );
